...
{
    public interface ICustomerFullNameUpdateService
    {
    ...
    public class CustomerFullNameUpdateReceiver : BackgroundService
    {
        ...
        private readonly ICustomerFullNameUpdateService _customerNameUpdateService;
        private readonly string _hostname;
        private readonly string _queueName;
        private readonly string _username;
        private readonly string _password;

        public CustomerFullNameUpdateReceiver(ICustomerFullNameUpdateService customerNameUpdateService, IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
